...
If Errorlevel 6 set facparms=flyc_param_infos_P4Pv2
If Errorlevel 5 set facparms=flyc_param_infos_p4p
If Errorlevel 4 set facparms=flyc_param_infos_P4A
If Errorlevel 3 set facparms=flyc_param_infos_p4STANDARD
If Errorlevel 2 set facparms=flyc_param_infos_spark
